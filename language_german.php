...
/* General */
$language['general']['username'] 		= 'Benutzername';
$language['general']['groups'] 			= 'Gruppen';
$language['general']['users'] 			= 'Benutzer';
$language['general']['primarygroup'] 		= 'Prim&auml;re Gruppe';
$language['general']['homedirectory'] 		= 'Homeverzeichnis';
$language['general']['enabled'] 		= 'Aktiv';
$language['general']['disabled'] 		= 'Gesperrt';
$language['general']['expiration'] 		= 'Ablaufdatum';
$language['general']['expiration_never']	= 'Niemals';
$language['general']['password'] 		= 'Passwort';
$language['general']['shell'] 			= 'Shell';
$language['general']['description'] 		= 'Beschreibung';
$language['general']['delete'] 			= 'L&ouml;schen';
$language['general']['delete_confirm']		= 'Wollen Sie wirklich l&ouml;schen?';
$language['general']['edit'] 			= '&Auml;ndern';
$language['general']['numlogins'] 		= 'Anzahl Anmeldungen';
$language['general']['lastlogin'] 		= 'Letzte Anmeldung';
$language['general']['lastlogout'] 		= 'Letzte Abmeldung';
$language['general']['userid'] 			= 'Benutzer-ID';
$language['general']['select_subsection']	= 'W&auml;hlen Sie einen Abschnitt';
$language['general']['error_occured'] 		= 'Fehler';
$language['general']['error_type'] 		= 'Type';
$language['general']['error_details'] 		= 'Details';
$language['general']['error_db_errors'] 	= 'Datenbank Fehler und Nachrichten';
$language['general']['log_in'] 			= 'Anmelden';


$language['general']['time_old'] 		= 'Wert unver&auml;ndert lassen';
$language['general']['time_yesterday'] 		= 'Gestern';
$language['general']['time_24h'] 		= '24 Stunden';
$language['general']['time_1week'] 		= '1 Woche';
$language['general']['time_2week'] 		= '2 Wochen';
$language['general']['time_1month'] 		= '1 Monat';
$language['general']['time_3month'] 		= '3 Monate';
$language['general']['time_6month'] 		= '6 Monate';
$language['general']['time_1year'] 		= '1 Jahr';
$language['general']['time_never'] 		= 'Niemals';
$language['general']['time_now'] 		= 'Jetzt';

$language['general']['name'] 			= 'Name';
$language['general']['email'] 			= 'E-mail';
$language['general']['adress'] 			= 'Adresse';
$language['general']['notes'] 			= 'Notizen';

$language['general']['yes'] 			= 'Ja';
$language['general']['no'] 			= 'Nein';

$language['general']['file_name'] 		= 'Dateiname';
$language['general']['file_size'] 		= 'Gr&ouml;&szlig;e';
$language['general']['file_created'] 		= 'Angelegt';
$language['general']['file_modified'] 		= 'Ge&auml;ndert';

/* Menuitems */
$language['menu']['mainpage'] 			= 'Startseite';
$language['menu']['users'] 			= 'Benutzer';
$language['menu']['groups'] 			= 'Gruppen';
$language['menu']['transfers'] 			= '&Uuml;bertragungen';
$language['menu']['status'] 			= 'Status';
$language['menu']['about'] 			= '&Uuml;ber';
$language['menu']['sysinfo'] 			= 'SysInfo';
$language['menu']['configure'] 			= 'Einrichten';
$language['menu']['reset'] 			= 'Reset';
$language['menu']['submit'] 			= 'Abschicken';
$language['menu']['traffic'] 			= 'Verkehr';
$language['menu']['section'] 			= 'Abschnitte';
$language['menu']['transfer_log'] 		= '&Uuml;bertragungs-Log';
$language['menu']['statistics'] 		= 'Statistiken';
$language['menu']['toplists'] 			= 'Toplisten';
$language['menu']['manual'] 			= 'Handbuch';
$language['menu']['cleanup'] 			= 'Aufr&auml;umen';
$language['menu']['log_files'] 			= 'Logdateien';
$language['menu']['log_out'] 			= 'Abmelden';
$language['menu']['user_details'] 		= 'Benutzerdetails';
...
/* Users */
$language['users']['newuser'] 			= 'Benuzer hinzuf&uuml;gen';
$language['users']['users'] 			= 'Benutzer';
$language['users']['cmd_output'] 		= 'Ausgabe';
$language['users']['pers_info'] 		= 'Pers&ouml;hnliche Details';
$language['users']['no_group'] 			= 'Nicht zugewiesen';

/* Userview */
$language['userv']['user_error'] 		= 'Benutzerfehler';
...
EOD;
$language['userv']['agu_info'] 			= 'Benutzerdetails &auml;ndern';
$language['userv']['deleteuser'] 		= 'Benutzer l&ouml;schen';
$language['userv']['userdeleted'] 		= 'Der Benutzer wurde gel&ouml;scht';
